...
def spot_diff(frame1, frame2):
	...
	# filename1=datetime.now().strftime('%y-%m-%d-%H:%M:%S')+".jpg"
	# i=0
	# filename1='s'+str(i)
	f = str(dt_string)
	cv2.imwrite(f"C:\\Users\\Muhammad Vasim\\Documents\\Documents(soft)\\smart-cctv-ver2.0-main\\stolen\\{f}.jpg", frame1)
