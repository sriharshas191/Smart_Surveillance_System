        ...
        if right == "" and left == "":
            if x > 500:
                ...
                if x < 200:
                    ...
                    x = 300
                    right, left = "", ""
                    cv2.imwrite(f"C:\\Users\\Muhammad Vasim\\Documents\\Documents(soft)\\smart-cctv-ver2.0-main\\visitors\\in\\{now}.jpg", frame1)
                ...
                if x > 500:
                    ...
                    x = 300
                    right, left = "", ""
                    cv2.imwrite(f"C:\\Users\\Muhammad Vasim\\Documents\\Documents(soft)\\smart-cctv-ver2.0-main\\visitors\\out\\{now}.jpg", frame1)
