...
icon = icon.resize((150,200), Image.Resampling.LANCZOS)
...
btn7_image = Image.open('icons/images.jpg')
...
btn7 = tk.Button(frame1, text="identify", fg="orange",command=fire, compound='left', image=btn7_image, height=90, width=180)
btn7['font'] = btn_font
